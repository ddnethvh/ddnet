...
void CGameControllerDDRace::OnPlayerConnect(CPlayer *pPlayer)
{
	...
	if(!Server()->ClientPrevIngame(ClientId))
	{
		...
		GameServer()->SendChatTarget(ClientId, "HvH (Hacker Vs. Hacker) Mod. Cheaters-welcome server.");
		GameServer()->SendChatTarget(ClientId, "please visit ddnethvh.fun to get cheats");
	}
}
